...
def fake_news_det1(news):
    ...
    print(prediction)
fake_news_det1("""Daniel Greenfield, a Shillman Journalism Fellow at the Freedom Center, is a New York writer focusing on radical Islam. 
